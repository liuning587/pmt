...
public class AFN09Hp0f1 extends DataBody{
	public static final String NAME=AFN09H.TerminalVersion;
	private static Logger logger = LoggerFactory.getLogger(AFN09Hp0f1.class);
