...
public class HardwareInitCommand extends SinglePacketCommand<HardwareInitCommand>{
	...
	public void sendOrder(String from, String to, String event, DecodedPacket context) throws Exception {
		...
		task.updateActionNow("发送硬件区初始化报文");
