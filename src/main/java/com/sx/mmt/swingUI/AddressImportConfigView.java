...
public class AddressImportConfigView extends JDialog{
	...
	public AddressImportConfigView(JDialog owner){
	...
	public void setAttribute(){
		...
		this.add(new JLabel("区划码所在列"),getGBC(1,1,1,1));
		this.add(district,getGBC(2,1,3,1));
		this.add(new JLabel("地址所在列"),getGBC(1,2,1,1));
	...
	public void setListener(){
		final AddressImportConfigView me=this;
